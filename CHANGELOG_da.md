...
* Testdata med eksempler kan findes på Github: GitHub - skat/emcs-b2b-ws-test-data at update/phase-4.2
...
* Test data with examples is located on Github: GitHub - skat/emcs-b2b-ws-test-data at update/phase-4.2
...
* Du kan først bestille integratorpakken, når den er klar. Vi giver besked, når du kan bestille pakken på [https://toldst.dk/driftsmeddelelser](https://toldst.dk/driftsmeddelelser).
...
You can only order the integrator package once it is ready. We will notify you when you can order the package from [https://toldst.dk/driftsmeddelelser](https://toldst.dk/driftsmeddelelser).
